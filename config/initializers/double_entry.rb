...
DoubleEntry.configure do |config|
  config.define_accounts do |accounts|
    ...
    if ENV["OVERDRAFT"] == "true" || ENV["OVERDRAFT"] == "1" 
      positive_values_only = false
    end
    accounts.define(identifier: :wallet, scope_identifier: accounts.active_record_scope_identifier(Wallet), positive_only: positive_values_only)
