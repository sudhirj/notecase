...
+ `wallet_ref` (string) - The wallet to recharge
+ `recharger_ref` (string) - The recharger from which the wallet is to be recharged
...
+ `wallet_ref` (string) - The wallet to recharge
+ `revenue_ref` (string) - The revenue account to which the credit is spent
+ `amount` (integer) - The amount in the lowest subdivision of the applicable currency (usually *cents/USD* or *paisa/INR*)
